...
const FlightList = ({
  ...
  if (searching) {
    return (
      <main
        role="region"
        aria-live="polite"
        className="flex items-center justify-center py-10 text-orange-500 max-w-7xl mx-auto"
      >
        <Clock className="w-5 h-5 animate-spin mr-2" />
        <span className="text-md font-medium">Searching for flights…</span>
      </main>
    );
  }
  ...
  if (!searched) {
    return (
      <main
        role="region"
        aria-live="polite"
        className="flex flex-col items-center justify-center py-16 text-gray-400 select-none max-w-7xl mx-auto"
      >
        <svg
        ...
        >
          <path
            ...
            d="M2.5 19.5l19-7-19-7v6l6 1-6 1v6z"
          />
        </svg>
        <p className="text-xl font-semibold text-orange-500">
          Start your search to find available flights
        </p>
      </main>
    );
  }
  if (flights.length === 0) {
    return (
      <section
        role="region"
        aria-live="polite"
        className="w-full flex justify-center py-16 text-gray-500"
      >
        <div className="flex flex-col items-center space-y-4 max-w-3xl w-full px-4 text-center">
          <svg
            fill="#fb923c"
            width="150px"
            height="150px"
  ...
  const sortedFlights = [...flights].sort((a, b) =>
    a.isConnecting === b.isConnecting ? 0 : a.isConnecting ? 1 : -1
  );

  return (
    <div className="space-y-5 mt- max-w-7xl mx-auto">
