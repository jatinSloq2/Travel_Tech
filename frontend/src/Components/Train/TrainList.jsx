  ...
  if (searching) {
    return (
      ...
      >
        ...
        <span className="text-md font-medium">Searching for trains…</span>
      </main>
    );
  }
    ...
    return (
      ...
      >
        ...
        <p className="text-xl font-semibold text-orange-500">
          Start your search to find available trains
        </p>
      </main>
    );
  }
      ...
      >
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col items-center space-y-6">
            ...
            <h2 className="text-2xl font-bold">No trains found</h2>
  ...
  return (
    <div className="space-y-5 max-w-7xl mx-auto">
      {sortedTrains.map((train) => (
        <TrainCard
          key={train._id || train.id || train.trainNumber}
          train={train}
